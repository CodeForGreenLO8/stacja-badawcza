...
inoremap <C-BS> 
nnoremap <silent>  :call smooth_scroll#up(  &scroll*2)
nnoremap <silent>  :call smooth_scroll#down(&scroll)
nnoremap  <Nop>
nnoremap h :Helptags
nnoremap m :Marks
nnoremap t :Tags
...
nnoremap  :tabnew
nnoremap <silent>  :call smooth_scroll#up(  &scroll)
nnoremap k :set nosplitbelow:new:set splitbelow
nnoremap j :set splitbelow:new
nnoremap h :set nosplitright:vnew:set splitright
nnoremap l :set splitright:vnew
map n î
map 1 
nnoremap ,d :YcmShowDetailedDiagnostic
map ,, <Plug>(easymotion-prefix)
nmap <silent> ,t :Vex!
nnoremap ,p :call PreviewMarkdown()
nnoremap ,l :redraw!
nnoremap H gT
nnoremap L gt
...
nmap ys <Plug>Ysurround
vnoremap <silent> zb :call smooth_scroll#bottom(1)
vnoremap <silent> zt :call smooth_scroll#top(1)
vnoremap <silent> zz :call smooth_scroll#center(1)
nnoremap <silent> zb :call smooth_scroll#bottom(0)
nnoremap <silent> zt :call smooth_scroll#top(0)
nnoremap <silent> zz :call smooth_scroll#center(0)
nnoremap <Plug>(-fzf-:) :
nnoremap <Plug>(-fzf-/) /
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/code-stats-vim,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/YouCompleteMe,~/.vim/plugged/vim-multiple-cursors,~/.vim/plugged/fzf.vim,~/.vim/plugged/fzf,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-repeat,~/.vim/plugged/ale,~/.vim/plugged/vim-easymotion,~/.vim/plugged/vim-smooth-scroll,~/.vim/plugged/vim-colorschemes,~/.vim/plugged/tern_for_vim,~/.vim/plugged/vim-airline-themes,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/tern_for_vim/after,~/.vim/after
set shiftwidth=4
...
silent only
cd ~/Coding/Stacja-Badawcza/sensors
...
badd +91 master.py
badd +0 \!/bin/bash
badd +0 DHT22Logger/examples/sensortest.py
badd +8 PMS5003/pm25pms5003.py
badd +0 PMS5003/Old/examples/all.py
badd +5 test.py
badd +0 \!/bin/bash\ (1)
argglobal
silent! argdel *
...
exe 'vert 3resize ' . ((&columns * 54 + 95) / 190)
argglobal
enew
file \!/bin/bash\ (1)
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((32 * winheight(0) + 18) / 36)
...
exe 'vert 2resize ' . ((&columns * 135 + 95) / 190)
exe 'vert 3resize ' . ((&columns * 54 + 95) / 190)
tabedit PMS5003/pm25pms5003.py
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('PMS5003/Old/examples/all.py') | buffer PMS5003/Old/examples/all.py | else | edit PMS5003/Old/examples/all.py | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
nmap <buffer> ,hu <Plug>(GitGutterUndoHunk)
...
16
normal! 0
lcd ~/Coding/Stacja-Badawcza/sensors
wincmd w
exe 'vert 1resize ' . ((&columns * 95 + 95) / 190)
exe 'vert 2resize ' . ((&columns * 94 + 95) / 190)
tabnext 1
